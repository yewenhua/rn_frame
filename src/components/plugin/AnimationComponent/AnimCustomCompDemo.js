...
import { ART, Animated, Easing, StatusBar, StyleSheet, Platform, View, Text, ScrollView} from 'react-native';
...
class DoubleBounce extends Component {
...
export default class AnimCustomCompDemo extends Component {
  constructor(props, context) {
    super(props, context);
  }
